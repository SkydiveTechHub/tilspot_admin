...
const PreviewTransportOrderModal = ({children, title, openModal, handleOk, handleCancel, d_location, a_location, imgUrl, a_time, d_time, amount, date, ticket, f_name,l_name, email, phone }) => {
