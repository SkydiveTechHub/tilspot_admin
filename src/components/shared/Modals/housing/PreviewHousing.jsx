...
const PreviewHousingOrderModal = ({children, title, openModal, handleOk, handleCancel, handleProceed, handleReturn, proceedText, returnText, imgUrl, provider, acctNo, amount }) => {
  const [secondModalOpen, setSecondModalOpen] = useState(false)
  const [openFailed, setOpenedFailed] = useState(false)
  return (
    <>
      <SuccessModal
        title={`Housing Transaction performed successfully`}
      ...
      <Modal className='basic-modal' title={'Housing Order'} open={openModal} onOk={handleOk} onCancel={handleCancel}>
...
export default PreviewHousingOrderModal;