...
const PreviewWasteOrderModal = ({children, title, openModal, handleOk, handleCancel, handleProceed, handleReturn, proceedText, returnText, imgUrl, provider, acctNo, amount }) => {
